...
<?php include 'header.php'; ?>
    ...
    <body class="login">
        ...
        <!-- <div data-url="login-light2.php" class="dark-mode-switcher cursor-pointer shadow-md fixed bottom-0 right-0 box border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-10 mr-10">
