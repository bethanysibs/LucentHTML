...
<body class="login">
    <div class="container w-full p-5 md:p-20 items-center justify-center">
        ...
        <div id="horizontal-form" class="p-5">
            <div class="preview">
                <div class="form-inline mt-5">
                    ...
                    <input id="horizontal-form-2" type="password" class="form-control" placeholder="Password">
                </div>
                ...
                <div class="w-96 intro-y">
                    ...
                    <div class="box px-5 py-8 mt-10 max-w-[450px] relative before:content-[''] before:z-[-1] before:w-[95%] before:h-full before:bg-slate-200 before:border before:border-slate-200 before:-mt-5 before:absolute before:rounded-lg before:mx-auto before:inset-x-0 before:dark:bg-darkmode-600/70 before:dark:border-darkmode-500/60">
                        ...
                        <div class="text-slate-500 flex text-xs sm:text-sm mt-4">
                            <a href="patientIdentifier.php">Patient Identifier</a> 
                        </div>
                    </div>
                </div>
            </div>
        </div> -->
        <!-- BEGIN: Dark Mode Switcher--> <!--TO BE UPDATED and transferred to an external file-->
        <div data-url="login-light.php" class="dark-mode-switcher cursor-pointer shadow-md fixed bottom-0 right-0 box border rounded-full w-40 h-12 flex items-center justify-center z-50 mb-10 mr-10">
